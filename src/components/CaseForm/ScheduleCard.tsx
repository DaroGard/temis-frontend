      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className={`w-full border rounded-md px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-links focus:border-transparent ${errors?.firstMeeting ? 'border-warning ring-red-200' : 'border-slate-300'
              }`}
          />
          {errors?.firstMeeting && (
            <p className="text-warning text-xs mt-1">{errors.firstMeeting.message}</p>
          )}
